...
def bruteforce1():
    for i in range(100000, 200000):
        resulted = requests.put("https://api.blooket.com/api/firebase/join", headers={"Referer":"https://www.blooket.com/"}, data={"id":f"{str(i)}", "name":f"goosey uwu"})
        resulted2 = requests.put("https://api.blooket.com/api/firebase/join", headers={"Referer":"https://www.blooket.com/"}, data={"id":f"{str(i+100000)}", "name":f"goosey uwu"})
