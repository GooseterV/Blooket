...
async function putSave(saveData) {
	const response = await fetch("https://api.blooket.com/api/towers/save", {
		headers: {
			"referer": "https://www.blooket.com/",
			"content-type": "application/json",
...
const saves = JSON.parse(atob(iF.contentWindow.prompt("Base64 encoded string of save (copied from exportTODSave.js)")));
