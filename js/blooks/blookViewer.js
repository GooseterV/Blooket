...
const blookUrls = {
	...
	"Rainbow Astronaut": "https://blooket.s3.us-east-2.amazonaws.com/blooks/bonus/space/redAstronaut.svg",
...
async function seeBlooksFunc(user) {
	...
	for (let blook of blookKeys) {
		...
		if (blook === "Megalodon") {
			sellPrice = 250;
		} else if (blook === "Snowman") {
			sellPrice = 75;
		} else if (blook === "Master Elf") {
			sellPrice = 350;
		} else {
			sellPrice = blookInfo["Sell Prices"][rarity];
		};
