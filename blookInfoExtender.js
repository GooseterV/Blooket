...
async function expandBlookInfo() {
    var blookKeys = Object.keys(blookUrls)
    ...
    for (var blookNum in blookKeys) {
        ...
        var blookName = blook;
        var blookBox = blookInfo["Blooks"][blook]["Box"]
        var rarity = blookInfo["Blooks"][blook]["Rarity"]
        var sellPrice = blookInfo["Sell Prices"][rarity]
        var dropRate = blookInfo["Blooks"][blook]["dropRate"]
        var rarityColor = rarityColors[rarity]
        var blookFunction = `() => 
        pass
        if (document.getElementsByClassName('styles__quantityText___JDfUO-camelCase').length > 2) {
            document.getElementsByClassName('styles__quantityText___JDfUO-camelCase')[2].remove()
        }
        if (document.getElementsByClassName('styles__timsCow___W6920-camelCase').length > 1) {
            document.getElementsByClassName('styles__timsCow___W6920-camelCase')[0].remove()
        }
        document.getElementsByClassName('styles__blook___2Yq1S-camelCase')[0].src = '${blookUrl}';
        document.getElementsByClassName('styles__blook___2Yq1S-camelCase')[0].alt = '${blookName} Blook';
        if (document.getElementsByClassName('styles__blook___2Yq1S-camelCase')[0].alt == 'Spooky Ghost Blook') {
            document.getElementsByClassName('styles__blook___2Yq1S-camelCase')[0].className += ' spookyghost'
        } else {
            document.getElementsByClassName('styles__blook___2Yq1S-camelCase')[0].className = 'styles__blook___2Yq1S-camelCase'
        }
        if (document.getElementsByClassName('styles__blook___2Yq1S-camelCase')[0].alt == 'Tim the Alien Blook') {
            var timCow = document.createElement('img')
            timCow.src = 'https://blooket.s3.us-east-2.amazonaws.com/blooks/farmAnimals/cow.svg'
            timCow.className = 'styles__timsCow___W6920-camelCase'
            document.getElementsByClassName('styles__headerBlookImage___AdnRV-camelCase')[0].appendChild(timCow)
        }

        document.getElementsByClassName('styles__priceContainer___1pnjg-camelCase')[0].children[0].innerText = 'Sell Price: ${sellPrice}';
        document.getElementsByClassName('styles__quantityText___JDfUO-camelCase')[0].innerText = 'Box: ${blookBox}';
        var newElement = document.createElement('div')
        newElement.className = 'styles__quantityText___JDfUO-camelCase'
        document.getElementsByClassName('styles__headerTextContainer___xVg-I-camelCase')[0].insertBefore(newElement, document.getElementsByClassName('styles__rarityText___3sXH2-camelCase')[0])
        newElement.innerText = 'Drop Rate: ${dropRate}';
    ...
    `
    if (blook != "Tim the Alien" && blook != "Spooky Ghost") {
    ...
    else if (blook == "Spooky Ghost") {
        var blookHtml = `<button onclick="${blookFunction}"
        role="button" tabindex="0" style="font-size: 0px; outline: none; user-select: none; margin: 5px 1vw; position: relative; border: none; backface-visibility: hidden; background-color: transparent;">
        <div class="styles__blookContainer___GKC0D-camelCase"
            style="z-index: 1; margin: 0px auto; width: 5vw; height: 5.75vw; cursor: pointer; position: relative; outline: none;">
            <img src="${blookUrl}" alt="${blookName} Blook" draggable="false" class="styles__blook___2Yq1S-camelCase spookyghost"></div>
        </button>`;
    }
    else if (blook == "Tim the Alien") {
        var blookHtml = `<button onclick="${blookFunction}"
        role="button" tabindex="0" style="font-size: 0px; outline: none; user-select: none; margin: 5px 1vw; position: relative; border: none; backface-visibility: hidden; background-color: transparent;">
        <div class="styles__blookContainer___GKC0D-camelCase"
            style="z-index: 1; margin: 0px auto; width: 5vw; height: 5.75vw; cursor: pointer; position: relative; outline: none;">
            <img src="${blookUrl}" alt="${blookName} Blook" draggable="false" class="styles__blook___2Yq1S-camelCase">
            <img src="https://blooket.s3.us-east-2.amazonaws.com/blooks/farmAnimals/cow.svg" class="styles__timsCow___W6920-camelCase" draggable="false">
            </div>
        </button>`;
    }
